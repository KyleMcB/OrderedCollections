...
interface MutableTreeTests<K : Comparable<K>, V> {
    ...
    fun inOrder() {
        ...
        Assertions.assertIterableEquals(list.sortedBy { it.first }, tree)
    }
    ...
    fun clear() {
        ...
        tree.clear()
        Assertions.assertIterableEquals(emptyList<Pair<K, V>>(), tree)
    }
    ...
    fun atOrNullFail() {
        ...
        list.remove(value)
        list.forEach { tree.insert(it) }
        Assertions.assertNull(tree.atOrNull(value.first))
    }
    ...
    fun headSet() {
        ...
        Assertions.assertIterableEquals(upperList, tree.headSet(value.first))
    }
    ...
    fun tailSet() {
        ...
        Assertions.assertIterableEquals(lowerList, tree.tailSet(value.first))
    }
